...
6. Panel: [`specs/CiteGuard-Panel-Day2-v3.pptx`](./specs/CiteGuard-Panel-Day2-v3.pptx) · Q&A [`CiteGuard-Panel-QA-v2.pdf`](./specs/CiteGuard-Panel-QA-v2.pdf) · simple walk [`CiteGuard-Simple-Walkthrough-v2.pdf`](./specs/CiteGuard-Simple-Walkthrough-v2.pdf) · Release: `v0.4.0`
...
- Panel deck + printables: [`specs/`](./specs/) (also mirrored under `demos/`)
